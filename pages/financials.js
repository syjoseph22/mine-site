...
export default function FinancialOverview() {
  return (
    <RootLayout>
    <div className="min-h-screen px-6 md:px-16 py-20 space-y-24">
      {/* Page Title */}
      ...
      <section className="max-w-4xl mx-auto gap-12 items-center">
        <div>
          <p className="text-[#0b1d2a] leading-relaxed mb-4 text-center content-center">
